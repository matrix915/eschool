...
if (isset($_GET['uploadFile'])) {
    ...
    header('location: ?CKEditorFuncNum=' . $_GET['CKEditorFuncNum'].'&fileName='.$fileName);
    exit();
}
...
<div id="fileBrowser">
    ...
    if(isset($_GET['fileName'])){
        $filePath = core_config::getUploadDir(TRUE) . '/' . $_GET['fileName'];    

        $fileNameArr = explode('.', $_GET['fileName']);
        $fileType = trim(strtolower(end($fileNameArr)));
