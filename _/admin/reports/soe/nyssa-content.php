...
$filter->setSchoolOfEnrollment(\mth\student\SchoolOfEnrollment::Nyssa);
...
foreach ($filter->getStudents() as $student) {
    ...
    $reportArr[] = [
        ...
        ($student->isNewFromSOE(\mth\student\SchoolOfEnrollment::Nyssa) ? 'New' : 'Return'),
        $student->getLastName(),
