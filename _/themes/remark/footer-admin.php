...
<footer class="site-footer">
    <div class="site-footer-legal"><?php core_loader::printMTHFooterContent(true);?></div>
</footer>
 <!-- Core  -->
 <?php core_loader::addJsRef('babel',core_config::getThemeURI().'/vendor/babel-external-helpers/babel-external-helpers.js')?>
  <?php core_loader::addJsRef('jQueryUI', '/_/includes/jquery-ui/js/jquery-ui-1.10.4.custom.min.js');?>
  ...
  <?php core_loader::addJsRef('typehead',core_config::getThemeURI().'/vendor/typehead/typehead.js')?>
  ...
  <?php core_loader::addJsRef('adminjs',core_config::getThemeURI().'/assets/js/admin.js')?>
  <?php core_loader::printJsCssRefs() ?>
