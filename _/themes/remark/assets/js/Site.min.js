    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery),
        ...
        Site = function(_Base) {
            ...
            return babelHelpers.inherits(Site, _Base), babelHelpers.createClass(Site, [{
                key: "initialize",
                value: function() {
                    babelHelpers.get(Site.prototype.__proto__ || Object.getPrototypeOf(Site.prototype), "initialize", this).call(this), this.startLoading(), this.initializePluginAPIs(), this.initializePlugins(), this.initComponents()
                }
            }, {
                key: "process",
                value: function() {
                    babelHelpers.get(Site.prototype.__proto__ || Object.getPrototypeOf(Site.prototype), "process", this).call(this), this.polyfillIEWidth(), this.initBootstrap(), this.setupMenubar(), this.setupFullScreen(), this.setupWave(), this.setupTour(), this.setupNavbarCollpase(), this.$el.on("click", ".dropdown-menu-media", function(e) {
                        e.stopPropagation()
                    })
                }
            }, {
                key: "_getDefaultMenubarType",
                value: function() {
                    return $BODY.hasClass("site-menubar-open") ? "open" : "hide"
                }
            }, {
                key: "menubarType",
                value: function(type) {
                    var toggle = function($el) {
                        $el.toggleClass("hided", !("open" === type)), $el.toggleClass("unfolded", !("open" === type))
                    };
                ...
                value: function() {
                    ...
                    (0, _jquery2.default)(document).on("click", '[data-toggle="menubar"]', function() {
                        ...
                        switch (type) {
                            case "open":
                                $BODY.removeClass("site-menubar-fixed"), type = "hide";
                                break;
                            case "hide":
                                $BODY.addClass("site-menubar-fixed"), type = "open"
                        }
                ...
                key: "setupWave",
                value: function() {
                    "undefined" != typeof Waves && (Waves.init(), Waves.attach(".site-menu-item > a", ["waves-classic"]), Waves.attach(".site-navbar .navbar-toolbar a", ["waves-light", "waves-round"]), Waves.attach(".btn", ["waves-light", "waves-round"]))
                }
            }, {
