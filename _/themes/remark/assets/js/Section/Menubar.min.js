    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery),
        ...
        _class = function(_Component) {
            function _class() {
                ...
                var _this = babelHelpers.possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(props)));
                return _this.$menuBody = _this.$el.children(".site-menubar-body")
                , _this.$menu = _this.$el.find("[data-plugin=menu]")
                , _this.$menuBody.length > 0 ?
                    (_this.initialized = !0,
                         _this.scrollable = new Scrollable(_this.$menuBody)
                         , $BODY.hasClass("site-menubar-fold") ? _this.isFold = !0 : _this.isFold = !1
                         , _this.isFold || _this.bindHover()
                         , $HTML.removeClass("css-menubar").addClass("js-menubar")
                         , _this.type = "open"
                         , _this.change(_this.type)
                         , _this
                    ) : (_this.initialized = !1, babelHelpers.possibleConstructorReturn(_this))
            }
            return babelHelpers.inherits(_class, _Component), babelHelpers.createClass(_class, [{
                key: "process",
                value: function() {
                    babelHelpers.get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "process", this).call(this), this.isFold || this.bindHover()
                }
            }, {
                key: "bindHover",
                value: function() {
                    ...
                    this.$el.on("mouseenter", function() {
                        $BODY.hasClass("site-menubar-fixed") || $BODY.hasClass("site-menubar-disable-hover") || $BODY.hasClass("site-menubar-changing") || _this2.change("open")
                    }).on("mouseleave", function() {
                        $BODY.hasClass("site-menubar-fixed") || $BODY.hasClass("site-menubar-disable-hover") || _this2.change("hide")
                    })
                }
            }, {
                key: "setMenuData",
                value: function() {
                    ...
                    api.folded = !("open" === this.type) && this.isFold, api.foldAlt = !1, api.outerHeight = this.$el.outerHeight()
                }
            }, {
                key: "getMenuApi",
                value: function() {
                ...
                key: "change",
                value: function(type) {
                    this.initialized && (this.reset(), this[type](), this.setMenuData()), this.type = type
                }
            }, {
                key: "animate",
                value: function(doing) {
                    ...
                    $BODY.addClass("site-menubar-changing"), setTimeout(function() {
                        doing.call(_this3), _this3.$el.trigger("changing.site.menubar");
                        var menuApi = _this3.getMenuApi();
                        menuApi && menuApi.refresh()
                    }, 10), setTimeout(function() {
                        callback.call(_this3), $BODY.removeClass("site-menubar-changing"), _this3.update(), _this3.$el.trigger("changed.site.menubar")
                    }, 250)
                }
            }, {
                key: "reset",
