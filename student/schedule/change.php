...
if (!empty($_GET['form'])) {
    ...
    if ($schedule->requireChangesPending($_POST['mth_schedule_period'])) {
        core_notify::addMessage('Your request has been submitted for review.');
    } else {
    ...
    if(parent.updateSchedule){
      ...
      parent.swal({
            title: "",
            text: "Your request to unlock the schedule has been submitted, and you will be notified via email when it is open to update.",
            type: "info",
