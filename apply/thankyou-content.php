<?php
cms_page::setPageTitle('Thank You!');
cms_page::setPageContent('<p>Your new student application was recieved.<p>
                          <p>You should recieve an email with a link to create a password. Using your email and password you will be able to login to view your student and view the application status.</p>');
